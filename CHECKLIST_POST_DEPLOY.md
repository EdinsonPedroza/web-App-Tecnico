...
> 🔐 **JWT_SECRET obligatorio:** genera un secreto aleatorio de al menos 32 bytes (lo que produce 64 caracteres hex si usas `openssl rand -hex 32`) antes de exponer el backend. No reutilices secretos de otros entornos ni lo dejes vacío.
